...
//   const handleNext = () => {
//     navigate(isEditing ? "/step6_review" : "/step2_skills", {
//       state: { 
//         ...previousState,
...
//         <h2 className="text-3xl font-semibold text-center text-[#205781]">{isEditing ? "Edit Disability Selection" : "Step 1: Select Your Disability"}</h2>
...
//             <p className="text-gray-900">{selectedDisabilities.join(", ")}</p>
//           </div>
//         )}
...
//               selectedDisabilities.length ? "bg-[#4F959D] text-white hover:bg-[#76b5a9]" : "bg-gray-400 text-gray-200 cursor-not-allowed"
//             }`}
//           >
//             Clear Selection
//           </button>
...
const Step1 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#205781] to-[#F6F8D5] text-white px-6 relative">
      ...
      <div className="absolute inset-0 flex justify-center items-center">
        ...
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className={`absolute w-${Math.floor(Math.random() * 10) + 5} h-${Math.floor(Math.random() * 10) + 5} bg-white opacity-20 rounded-full`}
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="absolute w-32 h-1 bg-white opacity-50"
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="absolute w-16 h-16 border-4 border-white rounded-full opacity-30"
            style={{ top: `${Math.random() * 100}%`, left: `${Math.random() * 100}%` }}
          ></div>
        ))}
      </div>
      
      <div className="bg-white text-gray-900 rounded-lg shadow-lg p-6 w-full max-w-2xl animate-fadeIn relative z-10">
        <h2 className="text-3xl font-semibold text-center text-[#205781]">{isEditing ? "Edit Disability Selection" : "Step 1: Select Your Disability"}</h2>
